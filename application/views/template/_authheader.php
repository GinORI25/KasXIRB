...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/NiceAdmin/');?>assets/img/idbar.jpg" rel="icon">
  <link href="<?= base_url('assets/NiceAdmin/');?>assets/img/idbar.jpg" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="<?= base_url('assets/NiceAdmin/');?>https://fonts.gstatic.com" rel="preconnect">
  <link href="<?= base_url('assets/NiceAdmin/');?>https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
