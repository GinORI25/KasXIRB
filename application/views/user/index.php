	...
	<div class="col-12 ">
		...
		<div class="d-flex justify-content-between">
				...
				<i class="ri-add-fill"></i> Tambah User
					...
					<a href=" <?= base_url('user/account'); ?>"><button type="button"
					class="btn btn-secondary rounded px-3 mb-4 " data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Detail Card">	<i class="ri-function-line"></i></button></a>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $usr['nama']; ?></td>
							<td><?= $usr['kelas']; ?></td>
							<td> <a class="dropdown-item d-flex align-items-center" href="<?= base_url('assets/NiceAdmin/profile/') . $usr['image']; ?>" class="fancybox" data-fancybox="gallery1">
							<img src="<?= base_url('assets/NiceAdmin/profile/') . $usr['image']; ?>" class="rounded-circle" style="width:2.5rem"  data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Lihat Foto"></a> </td>
							<td><?= $usr['level']; ?></td>
							<td>
								...
								<button class="btn btn-warning m-2" data-bs-toggle="modal" data-bs-target="#EditUser<?= $usr['id_user']; ?>"><i
										class="ri-ball-pen-line"></i></button>
							</td>
						</tr>
